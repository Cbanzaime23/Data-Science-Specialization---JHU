...
---
### Goal: The overall goal of this assignment is to explore the National Emissions Inventory database and see what it say about fine particulate matter pollution in the United states over the 10-year period 1999–2008.
...
```{r, echo = TRUE}
# png(file = "./Plots/plot2.png", width = 800, height = 600, units = "px", pointsize = 12)
...
```{r, echo=TRUE}
# png(file = "./Plots/plot3.png", width = 800, height = 600, units = "px", pointsize = 12)
...
```{r, echo = TRUE}
# png(file = "./Plots/plot4.png", width = 800, height = 600, units = "px", pointsize = 12)
...
```{r, echo = TRUE}
# png(file = "./Plots/plot5.png", width = 800, height = 600, units = "px", pointsize = 12)
...
```{r, echo= TRUE}
# png(file = "./Plots/plot6.png", width = 800, height = 600, units = "px", pointsize = 12)
